...
ruleorder: csv_to_pickle_filter > pickle_to_files > compute_features > merge_all_features > feature_statistic > make_long_images > make_square_images
...
rule make_long_images:
    ...
    run:
        ...
        savePickle(all_chr, "data/output/make_long_images/{}.pickle".format(str(input[0]).split("/")[-1]))
...
rule make_square_images:
    ...
    run:
        ...
        savePickle(chr_data_binned, "data/output/make_square_images/{}.pickle".format(str(input[0]).split("/")[-1]))